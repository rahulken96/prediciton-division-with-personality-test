...
<body>
    <div class="container w-full mx-auto">
        ...
        <div class="bg-purple-300 py-3 px-4 italic text-justify my-3">
            <blockquote>Orang yang spontan, bersemangat dan antusias, hidup tidak akan membosankan saat berdekatan dengan mereka. Mudah berteman, ramah, menyenangkan, optimis, ceria, suka menjadi pusat perhatian, menghindari konflik, cepat, dan praktis.</blockquote>
        </div>
        <p class="text-indigo-900"><b>Profesi</b> : Entertainer, Seniman, Marketing, Konselor, Desainer, Tour Guide</p>
        <p class="text-indigo-900"><b>Partner</b> : ISTJ atau ISFJ</p>
        <p class="text-indigo-900"><b>Tokoh Terkenal</b> : Bill Clinton, Pablo Picasso, Woody Harrelson</p>

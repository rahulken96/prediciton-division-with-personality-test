...
<body>
    <div class="container w-full mx-auto">
        ...
        <div class="bg-purple-300 py-3 px-4 italic text-justify my-3">
            <blockquote>Orang yang sangat peduli, sosial dan populer, selalu ingin membantu. Hangat, banyak bicara, membutuhkan keseimbangan, santai, sederhana, teliti, dan rajin merawat apa yang dimiliki.</blockquote>
        </div>
        <p class="text-indigo-900"><b>Profesi</b> :  Perencana Keuangan, Perawat, Guru, Bidang anak-anak</p>
        <p class="text-indigo-900"><b>Partner</b> : ISFP atau INFP</p>
        <p class="text-indigo-900"><b>Tokoh Terkenal</b> : Bill Clinton, Sally Field</p>

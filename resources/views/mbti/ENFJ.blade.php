...
<body>
    <div class="container w-full mx-auto">
        ...
        <p class="mt-10 text-lg uppercase text-indigo-900">Nama : {{ $nama ?? 'Rofi' }}</p>
        ...
        <div class="bg-purple-300 py-3 px-4 italic text-justify my-3">
            <blockquote>Pemimpin yang karismatik dan menginspirasi, mampu memukau pendengarnya. Kreatif, peduli apa kata orang lain, pandai bergaul, menyukai tantangan, dan butuh apresiasi.</blockquote>
        </div>
        <p class="text-indigo-900"><b>Profesi</b> :  Konsultan, Psikolog, Pengajar, Marketing, Entertainer, Penulis, Motivator</p>
        <p class="text-indigo-900"><b>Partner</b> : INFP atau ISFP</p>
        <p class="text-indigo-900"><b>Tokoh Terkenal</b> : Abraham Lincoln, Johnny Depp, Oprah Winfrey, Barack Obama</p>

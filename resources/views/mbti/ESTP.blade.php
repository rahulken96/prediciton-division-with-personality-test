...
<body>
    <div class="container w-full mx-auto">
        ...
        <div class="bg-purple-300 py-3 px-4 italic text-justify my-3">
            <blockquote>Orang yang cerdas, bersemangat dan sangat tanggap, benar-benar menikmati hidup yang menantang. Spontan, aktif, enerjik, ceplas-ceplos, berkarisma, mudah beradaptasi.</blockquote>
        </div>
        <p class="text-indigo-900"><b>Profesi</b> : Marketing, Sales, Polisi, Pebisnis, Pialang Saham</p>
        <p class="text-indigo-900"><b>Partner</b> : ISFJ atau ISTJ</p>
        <p class="text-indigo-900"><b>Tokoh Terkenal</b> : Madonna, Donald Trump, Lucille Ball</p>

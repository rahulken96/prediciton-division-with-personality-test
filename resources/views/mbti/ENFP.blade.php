...
<body>
    <div class="container w-full mx-auto">
        ...
        <div class="bg-purple-300 py-3 px-4 italic text-justify my-3">
            <blockquote>Semangat yang antusias, kreatif dan bebas bergaul, yang selalu dapat menemukan alasan untuk tersenyum. Ramah, imajinatif, pandai berkomunikasi, dan bisa membaca kebutuhan orang lain.</blockquote>
        </div>
        <p class="text-indigo-900"><b>Profesi</b> :  Psikolog, Entertainer, Pengajar, Motivator, Presenter, Reporter, MC, Seniman</p>
        <p class="text-indigo-900"><b>Partner</b> : INTJ atau INFJ</p>
